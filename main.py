...
@Dragon_2022_D.on_message(filters.command("start"))
async def start(client, message):
   if message.chat.type == 'private':
       await Dragon_2022_D.send_message(
...
▷ BY : @Dragon_2022_D
                            ...
                            reply_markup=InlineKeyboardMarkup(
                                ...
                                [
                                        ...
                                        InlineKeyboardButton('▷ DEV', url='https://T.ME/Dragon_2022_D')
                                    ],]
                            ),        
            disable_web_page_preview=True,        
            parse_mode="html")

@Dragon_2022_D.on_message(filters.command("help"))
...
@Dragon_2022_D.on_message(filters.command("about"))
...
<b>▷ ‍🔧 المطور:</b> <a href="https://t.me/T2R_9">اضغط هنا</a>

<b>▷ 📚 المكتبة:</b> <a href="https://github.com/pyrogram/pyrogram">Pyrogram</a>

<b>▷ 📢 قناة السورس:</b> @Dragon_2022_D

<b>▷ 🌀 ملفات السورس:</b> <a href="https://github.com/taher-1/youtube">اضغط هنا</a>""",
     reply_markup=InlineKeyboardMarkup(
                                [[
                                        InlineKeyboardButton(
                                            "🔙 رجـوع", callback_data="help"),
                                        InlineKeyboardButton(
                                            "المطـور ⛓️️", url="https://t.me/T2R_9"),
                                  ],]
                            ),        
            disable_web_page_preview=True,        
            parse_mode="html")
...
@Dragon_2022_D.on_message(filters.private
                   & filters.text
                   & ~filters.edited
        ...
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=message.chat.id,
                    text="▾∮ تم حظرك من استخدام البوت تواصل مع مطوري [اضغط هنا](https://t.me/T2R_9).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
            ...
            await c.send_message(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("قناة السورس", url=f"https://t.me/Dragon_2022_D")
                        ]
                    ]
                ),
                parse_mode="markdown"
            ...
            await c.send_message(
                chat_id=message.chat.id,
                text="هنالك شي خطا تواصل مع مطوري [اضغط هنة](https://t.me/T2R_9).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
...
@Dragon_2022_D.on_callback_query(filters.regex("^ytdl_audio$"))
...
@Dragon_2022_D.on_callback_query(filters.regex("^ytdl_video$"))
...
@Dragon_2022_D.on_callback_query()
